...
CONFIG = {"MONGO_DATABASE": "emanual", "MONGO_COLLECTION": "manuals-content"}
...
def connect(user=None, password=None, uri=None):
    ...
    connection_string = f"mongodb+srv://{mongodb_user}:{mongodb_password}@{mongodb_host}/"

    client = pymongo.MongoClient(connection_string, connect=True, appname="emanual-bot")
