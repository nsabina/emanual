...
def fastapi_app():
    ...
    interface = gr.Interface(
        ...
        examples=[
            ...
            "How do you maintain seat belts?",
            ...
            "What should you check before using the CLASSIKA PID for the first time?",
            ...
            "What should you do to keep the portafilter warm?",
            ...
            "How do you make a cappuccino with the CLASSIKA PID?",
